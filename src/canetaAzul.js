...
const canetaAzulText = 'Caneta azul, azul caneta. Caneta azul, ta marcada com minhas letraa\n';
        ...
        dados: [
            {
                acao: 'audio',
                acao_dados: {
                    url_audio: 'https://github.com/fabriciodanioj/caneta-azul-pegadinha/raw/master/resources/caneta-azul.mp3'
                }
            }
        ],
        bina: from
